  ...
  return (
    <section className={styles.container} id="home">
        <div className={styles.content}>
            ...
            <a href="https://wa.me/5555996578731?text=Olá, Josiane. Gostaria de fazer um orçamento para a tradução/versão de um documento." target='_blank' className={styles.contatoBtn}>Contate-me</a>
        </div>
